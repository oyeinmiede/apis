...
function NotificationBell() {
    ...
    const read = notifications.filter(n => n.read).slice(0, 5);
    ...
    return (
        <Popover>
            ...
            >
                ...
                {!!unread.length && (
                    <>
                        <span className="notification-group-title">Unread</span>
                ...
                {!!read.length && (
                    <>
                        <span className="notification-group-title">Earlier</span>
...
function NotificationItem({ notification, unread, onClick }) {
